...
export default class WorkshopIndex extends React.Component {
  render() {
    ...
    return (
      <Layout>
        <Seo
          title={`All Workshops - Page ${this.props.pageContext.pageNumber}`}
          description={`Index of all workshops. Page ${this.props.pageContext.pageNumber}`}
        />
        <div className="pv5 flex items-center justify-center bg-washed-red">
          <h1 className="fw1 tc f2 display">Workshops</h1>
        </div>
...
export const workshopListQuery = graphql`
